...
//display image with different dropdowns (logic will be the same as "choose location"
      ...
      <div className="quiz-container">
        ...
        {currentSpecies && (
          <div className="quiz-image">
            ...
            <div>
            <label>Order:</label>
            <select value={order} onChange={(e) => handleOrderSelect(e.target.value)} disabled = {isChecked}>
          ...
          <div>
            ...
            <select
              ...
              disabled={isChecked || !order} // Disable if order is not selected
            >
          ...
          <div>
            ...
            <select
              ...
              disabled={isChecked || !family} // Disable if family is not selected
            >
